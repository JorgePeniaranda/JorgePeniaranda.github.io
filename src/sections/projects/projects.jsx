        ...
        <div className="container">
          <div id="timeLine">
            <div className="left cardsContainer">
              <Slide left>
                <a href="https://jildam.curseofacademy.com.ar/" className="card" target='_blank' rel="noreferrer">
                  <b>2020</b>
                  <span>Jildam</span>
              ...
              <Slide left>
                <a href="#" className="card" /* target='_blank' rel="noreferrer" */>
                  <b>2022</b>
                  <span>Namatbe</span>
            ...
            <div className="right cardsContainer">
              <Slide right>
                <a href="https://goldenduck.netlify.app/" className="card" target='_blank' rel="noreferrer">
                  <b>2021</b>
